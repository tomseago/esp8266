...
void 
SignUI::h_hello(AsyncWebServerRequest *req)
{
...
void 
SignUI::h_config_js(AsyncWebServerRequest *req)
{
...
void 
SignUI::h_reset(AsyncWebServerRequest *req)
{
    AsyncResponseStream *response = req->beginResponseStream("text/html");
...
void 
SignUI::h_404(AsyncWebServerRequest *req)
{
    AsyncResponseStream *response = req->beginResponseStream("text/html");
...
void 
SignUI::h_socket(AsyncWebSocket * server, AsyncWebSocketClient * client, AwsEventType type, void * arg, uint8_t *data, size_t len)
{
...
void
SignUI::broadcastState(uint16_t state)
{
